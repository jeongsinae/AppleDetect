...
with open(output_files_path + "/output.txt", 'w') as output_file:
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        rounded_prec_sum=round(prec_sum/len(prec),2)
        rounded_rec_sum=round(rec_sum/len(rec),2)
        #f1_score=round(2*(rounded_rec_sum*rounded_prec_sum)/(rounded_rec_sum+rounded_prec_sum),2)
        #accuracy=
        output_file.write(text + "\n Precision: " + str(rounded_prec) + "\n Recall :" + str(rounded_rec) + "\n\n")
        output_file.write("precision_avg : "+str(rounded_prec_sum)+"\n recall_avg : "+str(rounded_rec_sum)+ "\n\n")
        #output_file.write("f1-score : "+str(f1_score)+"\n\n")
